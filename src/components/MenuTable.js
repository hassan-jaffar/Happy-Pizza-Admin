...
function MenuTable() {
  ...
  async function editItemImage() {
    ...
    try {
      const result = await axios.post(
        " https://apinodejs.creativeparkingsolutions.com/api/admin/updateitemimage",
        formData, config
      ).data;
      console.log(result);
      update1();
  ...
  //   try {
  //     const result = await axios.post(
  //       " https://apinodejs.creativeparkingsolutions.com/api/admin/imageuploadcheck",
  //       formData,config
  //     ).data;
  //     console.log(result);
  //     update1();
                                            ...
                                            <div className="row">
                                              ...
                                              <div className="col-6 text-end">
                                                <button
                                                  ...
                                                  type="button"
                                                  data-bs-toggle="modal"
                                                  data-bs-target={`#addimgModal${items.ID}`}
                                                  onClick={() => { ItemIdUpdate(items.ID) }}
                                                >
                                ...
                                <div className="modal-dialog">
                                  <div className="modal-content">
                                    ...
                                    <div className="modal-footer">
                                      ...
                                      <button type="button" className="btn btn-primary" onClick={() => { editItemImage() }}>
                                        Save
                                      </button>
                                    </div>
                                  </div>
