      ...
      <nav className="navbar-light justify-content-center mainnavbar">
        <div className="row menu responsiveness">
          <div className="col-md-4 menuitems text-start">
            ...
            >
              <h2><i className="fa-solid fa-bars"></i></h2>
            </button>
          </div>
          ...
          {getstatus==="true" ? (<>
            <div className="dropdown">
              ...
              <li className="dropdown-item"><p className="dropdown-item text-center boldtext">{getstatus === "true" ? (<>
              ...
              <li><hr className="dropdown-divider"/></li>
                ...
                <li>
                  <Link to="/home">
                    <button className="btn btn-light userdditem dropdown-item">Dashboard</button>
                  </Link>
                </li>
                <li>
                  <Link to="/liveorders">
                    <button className="btn btn-light userdditem dropdown-item">Live Orders</button>
                  </Link>
                </li>
                <li>
                  <Link to="/orders">
                    <button className="btn btn-light userdditem dropdown-item">Orders</button>
                  </Link>
                </li>
                <li>
                <Link to="/setting">
                    <button className="btn btn-light userdditem dropdown-item">Restaurant</button>
                  </Link>
                </li>
                <li>
                <Link to="/menu">
                    <button className="btn btn-light userdditem dropdown-item">Menu</button>
                  </Link>
                  <Link to="/change-password">
                    <button className="btn btn-light userdditem dropdown-item pinkbg"><i className="fa-solid fa-lock btnicon"></i>Close Shift</button>
                  </Link>
                </li>
                <li><hr className="dropdown-divider"/></li>
                <Link to="/">
