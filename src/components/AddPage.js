...
function AddPage() {
  ...
  async function add() {
    ...
    try {
      ...
      // setloading(true)
      const result = await axios.post("https://apinodejs.creativeparkingsolutions.com/api/superadmin/addpage",details).data;
      console.log(result)
  ...
  async function edit() {
    ...
    // try {
    //   const result = await axios.post("https://apinodejs.creativeparkingsolutions.com/api/superadmin/editpage",details).data; 
    // } catch (error) {
    //   console.log(error)
    // }
  }
  ...
  useEffect(() => {
    async function fetchData() {
      try {
        const data = await (
          await axios.get(`https://apinodejs.creativeparkingsolutions.com/api/superadmin/editpageitem/${ID}`)
        ).data;
